...
aaa = 0
bbb=0
A_img_paths = glob.glob(os.path.join('preprocessedData', 'lesion_type_5', '*', '*.png'))

true, _ = util.make_zip_dataset(A_img_paths, 32, 128, 128, training=True, repeat=False)
...
for i in true:
    ...
    aaa += 1
print('真实图片读取完毕')
generator = keras.models.load_model('G.h5')
